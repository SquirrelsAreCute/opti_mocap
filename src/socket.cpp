...
UdpMulticastSocket::UdpMulticastSocket( const int local_port, const std::string multicast_ip ) 
{
  ...
  /* m_local_addr.sin_addr.s_addr = inet_addr("169.254.235.217"); */
  /* m_local_addr.sin_addr.s_addr = inet_addr("169.254.0.1"); */
  /* m_local_addr.sin_addr.s_addr = inet_addr("10.254.239.1"); */
  m_local_addr.sin_addr.s_addr = inet_addr("192.168.0.100");
